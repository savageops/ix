---
id: 142h-warm-index-compaction-ops-hardening
...
phase: h
status: done
patch_scope: "Test branch-switch, rename storm, delete/recreate, and partial write failures."
blast_radius: high
...
acceptance: "Adversarial mutation tests is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "C:\\Users\\Savage\\.local\\zig\\zig-x86_64-windows-0.16.0\\zig.exe build test --summary all -> Build Summary: 3/3 steps succeeded; 161/161 tests passed | test success | +- run test 161 pass (161 total) 859ms MaxRSS:12M | +- compile test Debug native success 4s MaxRSS:448M"
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Adversarial mutation tests preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 142g-warm-index-compaction-ops-hardening is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "142g-warm-index-compaction-ops-hardening"
next_todo: /todo/pending/142i-warm-index-compaction-ops-hardening.md
...
resumption_point: ""
---
# 142h Adversarial mutation tests

## Execute Now
Adversarial mutation tests: Test branch-switch, rename storm, delete/recreate, and partial write failures.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Adversarial mutation tests must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Adversarial mutation tests must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Adversarial mutation tests must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/142g-warm-index-compaction-ops-hardening.md` exists and carries non-PLACEHOLDER evidence.
...
- Adversarial mutation tests is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/142i-warm-index-compaction-ops-hardening.md`
...
- [x] Move this file to `/todo/changelog/142h-warm-index-compaction-ops-hardening.md` verified.
