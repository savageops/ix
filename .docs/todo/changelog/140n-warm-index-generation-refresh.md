---
id: 140n-warm-index-generation-refresh
...
phase: n
status: done
patch_scope: "Measure generation-open overhead and compare to current cold/hot paths."
blast_radius: high
...
acceptance: "Benchmark gate is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "C:\\Users\\Savage\\.local\\zig\\zig-x86_64-windows-0.16.0\\zig.exe build test --summary all -> exit 0; Build Summary: 3/3 steps succeeded; 124/124 tests passed. Release build passed: Build Summary: 3/3 steps succeeded. Benchmark artifact .docs/research/2026-05-11-generation-open-benchmark.md records current_manifest_read_10000_total_ms=345.586 avg_us=34.559 and release_search_ms=10.787, 7.533, 6.615, 6.327, 6.705 with no foreground acceleration claim."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Benchmark gate preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 140m-warm-index-generation-refresh is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "140m-warm-index-generation-refresh"
next_todo: /todo/pending/140o-warm-index-generation-refresh.md
...
## Execute Now
Benchmark gate: Measure generation-open overhead and compare to current cold/hot paths.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Benchmark gate must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Benchmark gate must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Benchmark gate must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/140m-warm-index-generation-refresh.md` exists and carries non-PLACEHOLDER evidence.
...
- Benchmark gate is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/140o-warm-index-generation-refresh.md`
...
- [x] Move this file to `/todo/changelog/140n-warm-index-generation-refresh.md` verified.
