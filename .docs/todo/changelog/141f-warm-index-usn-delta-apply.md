---
id: 141f-warm-index-usn-delta-apply
...
phase: f
status: done
patch_scope: "Read bounded USN record batches with timeout/cancellation points."
blast_radius: high
...
acceptance: "Read batch loop is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "C:\\Users\\Savage\\.local\\zig\\zig-x86_64-windows-0.16.0\\zig.exe build test --summary all -> exit 0; Build Summary: 3/3 steps succeeded; 136/136 tests passed. Changed file: src/core/usn.zig. Added readBatchRequest, bounded parseReadBatch, ReadBatchOptions, UsnRecordSummary, ReadBatchResult, hostile-buffer checks for max bytes/truncated records/cancellation, and fake V2 batch tests."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Read batch loop preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 141e-warm-index-usn-delta-apply is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "141e-warm-index-usn-delta-apply"
next_todo: /todo/pending/141g-warm-index-usn-delta-apply.md
...
resumption_point: ""
---
# 141f Read batch loop

## Execute Now
Read batch loop: Read bounded USN record batches with timeout/cancellation points.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Read batch loop must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Read batch loop must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Read batch loop must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/141e-warm-index-usn-delta-apply.md` exists and carries non-PLACEHOLDER evidence.
...
- Read batch loop is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/141g-warm-index-usn-delta-apply.md`
...
- [x] Move this file to `/todo/changelog/141f-warm-index-usn-delta-apply.md` verified.
