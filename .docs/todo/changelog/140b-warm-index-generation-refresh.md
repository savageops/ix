---
id: 140b-warm-index-generation-refresh
...
phase: b
status: done
patch_scope: "Add GenerationManifest structs with segment list, parent, root, and epoch fields."
blast_radius: high
...
acceptance: "Manifest type skeleton is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "Validation: `zig build test --summary all` exit 0 -> Build Summary: 3/3 steps succeeded; 112/112 tests passed. Added `src/core/generation.zig` with GenerationManifestHeader, GenerationManifest, GenerationSegment, root/epoch/parent fields, segment-kind list, and fail-closed skeleton validation."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Manifest type skeleton preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 140a-warm-index-generation-refresh is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "140a-warm-index-generation-refresh"
next_todo: /todo/pending/140c-warm-index-generation-refresh.md
...
resumption_point: ""
---
# 140b Manifest type skeleton

## Execute Now
Manifest type skeleton: Add GenerationManifest structs with segment list, parent, root, and epoch fields.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Manifest type skeleton must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Manifest type skeleton must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Manifest type skeleton must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/140a-warm-index-generation-refresh.md` exists and carries non-PLACEHOLDER evidence.
...
- Manifest type skeleton is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/140c-warm-index-generation-refresh.md`
...
- [x] Move this file to `/todo/changelog/140b-warm-index-generation-refresh.md` verified.
