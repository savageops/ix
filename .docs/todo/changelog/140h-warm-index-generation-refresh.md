---
id: 140h-warm-index-generation-refresh
...
phase: h
status: done
patch_scope: "Keep prior generation live until no reader can observe a broken state."
blast_radius: high
...
acceptance: "Old generation retention is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "Validation: `zig build test --summary all` exit 0 -> Build Summary: 3/3 steps succeeded; 120/120 tests passed. Added readerPinRetainedAfterPublish and retention test proving a prior epoch manifest remains readable after publishing the next generation."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Old generation retention preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 140g-warm-index-generation-refresh is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "140g-warm-index-generation-refresh"
next_todo: /todo/pending/140i-warm-index-generation-refresh.md
...
resumption_point: ""
---
# 140h Old generation retention

## Execute Now
Old generation retention: Keep prior generation live until no reader can observe a broken state.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Old generation retention must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Old generation retention must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Old generation retention must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/140g-warm-index-generation-refresh.md` exists and carries non-PLACEHOLDER evidence.
...
- Old generation retention is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/140i-warm-index-generation-refresh.md`
...
- [x] Move this file to `/todo/changelog/140h-warm-index-generation-refresh.md` verified.
