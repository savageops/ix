---
id: 142c-warm-index-compaction-ops-hardening
...
phase: c
status: done
patch_scope: "Merge postings/catalog deltas into a compacted generation."
blast_radius: high
...
acceptance: "Merge writer is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "C:\\Users\\Savage\\.local\\zig\\zig-x86_64-windows-0.16.0\\zig.exe build test --summary all -> exit 0; Build Summary: 3/3 steps succeeded; 152/152 tests passed"
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Merge writer preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 142b-warm-index-compaction-ops-hardening is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "142b-warm-index-compaction-ops-hardening"
next_todo: /todo/pending/142d-warm-index-compaction-ops-hardening.md
...
## Execute Now
Merge writer: Merge postings/catalog deltas into a compacted generation.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Merge writer must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Merge writer must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Merge writer must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/142b-warm-index-compaction-ops-hardening.md` exists and carries non-PLACEHOLDER evidence.
...
- Merge writer is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/142d-warm-index-compaction-ops-hardening.md`
...
- [x] Move this file to `/todo/changelog/142c-warm-index-compaction-ops-hardening.md` verified.
