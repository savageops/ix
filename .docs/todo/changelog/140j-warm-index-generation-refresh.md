---
id: 140j-warm-index-generation-refresh
...
phase: j
status: done
patch_scope: "Allow search to use current generation when complete, else fall back safely."
blast_radius: high
...
acceptance: "Search adoption guard is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "Validation: `zig build test --summary all` exit 0 -> Build Summary: 3/3 steps succeeded; 122/122 tests passed. Added tryPinCurrentGeneration adoption guard: valid manifest returns ReaderPin; missing, wrong-root, or malformed manifest returns null so search can fall back safely."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Search adoption guard preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 140i-warm-index-generation-refresh is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "140i-warm-index-generation-refresh"
next_todo: /todo/pending/140k-warm-index-generation-refresh.md
...
resumption_point: ""
---
# 140j Search adoption guard

## Execute Now
Search adoption guard: Allow search to use current generation when complete, else fall back safely.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Search adoption guard must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Search adoption guard must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Search adoption guard must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/140i-warm-index-generation-refresh.md` exists and carries non-PLACEHOLDER evidence.
...
- Search adoption guard is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/140k-warm-index-generation-refresh.md`
...
- [x] Move this file to `/todo/changelog/140j-warm-index-generation-refresh.md` verified.
