---
id: 140g-warm-index-generation-refresh
...
phase: g
status: done
patch_scope: "Make catalog/postings writers publish through generation directories."
blast_radius: high
...
acceptance: "Index writer integration is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "Validation: `zig build test --summary all` exit 0 -> Build Summary: 3/3 steps succeeded; 119/119 tests passed. Added SegmentPayload and publishGenerationPayloads so catalog/postings bytes publish into generation_dir via atomic file writes, then serialize/publish a manifest and return a validated ReaderPin."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Index writer integration preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 140f-warm-index-generation-refresh is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "140f-warm-index-generation-refresh"
next_todo: /todo/pending/140h-warm-index-generation-refresh.md
...
resumption_point: ""
---
# 140g Index writer integration

## Execute Now
Index writer integration: Make catalog/postings writers publish through generation directories.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Index writer integration must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Index writer integration must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Index writer integration must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/140f-warm-index-generation-refresh.md` exists and carries non-PLACEHOLDER evidence.
...
- Index writer integration is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/140h-warm-index-generation-refresh.md`
...
- [x] Move this file to `/todo/changelog/140g-warm-index-generation-refresh.md` verified.
