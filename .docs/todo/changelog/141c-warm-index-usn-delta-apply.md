---
id: 141c-warm-index-usn-delta-apply
...
phase: c
status: done
patch_scope: "Capture NTFS volume identity and journal ID in JournalCursor."
blast_radius: high
...
acceptance: "Volume identity is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "C:\\Users\\Savage\\.local\\zig\\zig-x86_64-windows-0.16.0\\zig.exe build test --summary all -> exit 0; Build Summary: 3/3 steps succeeded; 129/129 tests passed. Changed file: src/core/usn.zig. Added VolumeIdentity and JournalCursor carrying root fingerprint, volume serial, filesystem kind, journal id, first/next/lowest-valid USN range, continuation guard, and fail-closed unsupported/discontinuous tests."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Volume identity preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 141b-warm-index-usn-delta-apply is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "141b-warm-index-usn-delta-apply"
next_todo: /todo/pending/141d-warm-index-usn-delta-apply.md
...
resumption_point: ""
---
# 141c Volume identity

## Execute Now
Volume identity: Capture NTFS volume identity and journal ID in JournalCursor.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Volume identity must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Volume identity must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Volume identity must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/141b-warm-index-usn-delta-apply.md` exists and carries non-PLACEHOLDER evidence.
...
- Volume identity is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/141d-warm-index-usn-delta-apply.md`
...
- [x] Move this file to `/todo/changelog/141c-warm-index-usn-delta-apply.md` verified.
