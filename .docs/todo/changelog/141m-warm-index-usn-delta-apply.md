---
id: 141m-warm-index-usn-delta-apply
...
phase: m
status: done
patch_scope: "Add guarded Windows tests and local smoke scripts for journal paths."
blast_radius: high
...
acceptance: "USN tests/smokes is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "powershell -NoProfile -ExecutionPolicy Bypass -File scripts\\smoke-usn-journal-paths.ps1 -> exit 0; Build Summary: 3/3 steps succeeded; 148/148 tests passed"
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "USN tests/smokes preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 141l-warm-index-usn-delta-apply is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "141l-warm-index-usn-delta-apply"
next_todo: /todo/pending/141n-warm-index-usn-delta-apply.md
...
resumption_point: ""
---
# 141m USN tests/smokes

## Execute Now
USN tests/smokes: Add guarded Windows tests and local smoke scripts for journal paths.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | USN tests/smokes must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | USN tests/smokes must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | USN tests/smokes must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/141l-warm-index-usn-delta-apply.md` exists and carries non-PLACEHOLDER evidence.
...
- USN tests/smokes is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/141n-warm-index-usn-delta-apply.md`
...
- [x] Move this file to `/todo/changelog/141m-warm-index-usn-delta-apply.md` verified.
