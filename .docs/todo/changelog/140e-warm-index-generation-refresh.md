---
id: 140e-warm-index-generation-refresh
...
phase: e
status: done
patch_scope: "Reject partial, wrong-root, unknown-segment, and future-version manifests."
blast_radius: high
...
acceptance: "Manifest load validation is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "Validation: `zig build test --summary all` exit 0 -> Build Summary: 3/3 steps succeeded; 117/117 tests passed. Added manifest byte serialization and validateManifestBytesForRoot fail-closed checks for partial/truncated input, wrong root, future version, incomplete manifest, invalid epoch/parent, unknown segment kind, wrong segment generation, and trailing data."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Manifest load validation preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 140d-warm-index-generation-refresh is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "140d-warm-index-generation-refresh"
next_todo: /todo/pending/140f-warm-index-generation-refresh.md
...
resumption_point: ""
---
# 140e Manifest load validation

## Execute Now
Manifest load validation: Reject partial, wrong-root, unknown-segment, and future-version manifests.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Manifest load validation must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Manifest load validation must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Manifest load validation must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/140d-warm-index-generation-refresh.md` exists and carries non-PLACEHOLDER evidence.
...
- Manifest load validation is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/140f-warm-index-generation-refresh.md`
...
- [x] Move this file to `/todo/changelog/140e-warm-index-generation-refresh.md` verified.
