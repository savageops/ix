---
id: 141b-warm-index-usn-delta-apply
...
phase: b
status: done
patch_scope: "Add minimal Windows API bindings/types for journal query and read."
blast_radius: high
...
acceptance: "USN FFI skeleton is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "C:\\Users\\Savage\\.local\\zig\\zig-x86_64-windows-0.16.0\\zig.exe build test --summary all -> exit 0; Build Summary: 3/3 steps succeeded; 127/127 tests passed. Changed files: src/core/usn.zig, src/main.zig. Added minimal FSCTL_QUERY_USN_JOURNAL / FSCTL_READ_USN_JOURNAL constants, DeviceIoControl binding, USN journal/read/request structs, USN record prefixes, and ABI offset tests. First run caught and corrected V2/V3 filename offset assertions before archival."
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "USN FFI skeleton preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 141a-warm-index-usn-delta-apply is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "141a-warm-index-usn-delta-apply"
next_todo: /todo/pending/141c-warm-index-usn-delta-apply.md
...
resumption_point: ""
---
# 141b USN FFI skeleton

## Execute Now
USN FFI skeleton: Add minimal Windows API bindings/types for journal query and read.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | USN FFI skeleton must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | USN FFI skeleton must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | USN FFI skeleton must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/141a-warm-index-usn-delta-apply.md` exists and carries non-PLACEHOLDER evidence.
...
- USN FFI skeleton is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/141c-warm-index-usn-delta-apply.md`
...
- [x] Move this file to `/todo/changelog/141b-warm-index-usn-delta-apply.md` verified.
