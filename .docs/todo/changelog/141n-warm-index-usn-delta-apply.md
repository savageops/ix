---
id: 141n-warm-index-usn-delta-apply
...
phase: n
status: done
patch_scope: "Document Windows-first freshness policy and fallback matrix."
blast_radius: high
...
acceptance: "Docs update is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
...
source_message_proof_obligation: "Docs update preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 141m-warm-index-usn-delta-apply is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "141m-warm-index-usn-delta-apply"
next_todo: /todo/pending/141o-warm-index-usn-delta-apply.md
...
## Execute Now
Docs update: Document Windows-first freshness policy and fallback matrix.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Docs update must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Docs update must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Docs update must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/141m-warm-index-usn-delta-apply.md` exists and carries non-PLACEHOLDER evidence.
...
- Docs update is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/141o-warm-index-usn-delta-apply.md`
...
- [x] Move this file to `/todo/changelog/141n-warm-index-usn-delta-apply.md` verified.
