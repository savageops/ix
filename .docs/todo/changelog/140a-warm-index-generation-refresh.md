---
id: 140a-warm-index-generation-refresh
...
phase: a
status: done
patch_scope: "Freeze generation visibility and fail-closed publish invariants."
blast_radius: high
...
acceptance: "Baseline contract lock is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "git branch --show-current; git log -1 --oneline; Test-Path .docs/research/2026-05-11-warm-layer-sidecar-architecture.md"
validation: "git branch --show-current; git log -1 --oneline; Test-Path .docs/research/2026-05-11-warm-layer-sidecar-architecture.md"
expected_exit_code: 0
expected_output_pattern: "develop"
evidence: "Validation: `git branch --show-current; git log -1 --oneline; Test-Path .docs/research/2026-05-11-warm-layer-sidecar-architecture.md` -> develop / 827d894 Add hidden warm indexd lifecycle / True. Baseline lock established after the hidden indexd lifecycle checkpoint."
conflict_surface: ""
invariants:
...
source_message_excerpt: "Make a commit. | Then fork to develop branch. | Use the planning spec skill after we've forked. | To slice this entire research into at least 90 to-do slices using the planning spec skill."
source_message_proof_obligation: "Baseline contract lock preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Commit aed5840 exists, current branch is develop, and .docs/research/2026-05-11-warm-layer-sidecar-architecture.md exists."
...
dependencies: ""
next_todo: /todo/pending/140b-warm-index-generation-refresh.md
...
resumption_point: ""
---
# 140a Baseline contract lock

## Execute Now
Freeze the baseline contract for Warm Index Generation Refresh before implementation begins.

## Why This Execution Unit Exists
This unit isolates baseline work for Warm Index Generation Refresh. The slice is intentionally narrow so candidate selection, index persistence, process lifecycle, and freshness semantics remain auditable across the warm-index program.

## Original User Message Proof

| Source Anchor | Verbatim Original Snippet | Slice Proof Obligation | Evidence Capture |
|---------------|---------------------------|------------------------|------------------|
| U1 | "Make a commit." | Baseline contract lock must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U2 | "Then fork to develop branch." | Baseline contract lock must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U4 | "Use the planning spec skill after we've forked." | Baseline contract lock must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Baseline contract lock must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The repository is on branch `develop` at or after commit `aed5840`.
...
|------|---------|-------------------|------------------------|-----------|
| 1 | `git branch --show-current; git log -1 --oneline; Test-Path .docs/research/2026-05-11-warm-layer-sidecar-architecture.md` | `0` | `develop` | yes |
...
- Baseline contract lock is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/140b-warm-index-generation-refresh.md`
...
- [x] Move this file to `/todo/changelog/140a-warm-index-generation-refresh.md` verified.
