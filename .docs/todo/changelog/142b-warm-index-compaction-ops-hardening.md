---
id: 142b-warm-index-compaction-ops-hardening
...
phase: b
status: done
patch_scope: "Select small/dense/deleted segments for merge without blocking readers."
blast_radius: high
...
acceptance: "Compaction planner is complete when the declared patch surface exists, public search compatibility is preserved, and the validation command records passing output or a concrete blocker."
exit_criterion: "zig build test"
validation: "zig build test"
expected_exit_code: 0
expected_output_pattern: "Build Summary"
evidence: "C:\\Users\\Savage\\.local\\zig\\zig-x86_64-windows-0.16.0\\zig.exe build test --summary all -> exit 0; Build Summary: 3/3 steps succeeded; 150/150 tests passed"
conflict_surface: ""
invariants:
...
source_message_proof_obligation: "Compaction planner preserves or implements the cited original request within the warm-layer execution program."
entry_state: "Dependency 142a-warm-index-compaction-ops-hardening is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "142a-warm-index-compaction-ops-hardening"
next_todo: /todo/pending/142c-warm-index-compaction-ops-hardening.md
...
resumption_point: ""
---
# 142b Compaction planner

## Execute Now
Compaction planner: Select small/dense/deleted segments for merge without blocking readers.
...
|---------------|---------------------------|------------------------|------------------|
| U3 | "Then let's attempt this experiment. Go all out." | Compaction planner must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U5 | "To slice this entire research into at least 90 to-do slices using the planning spec skill." | Compaction planner must preserve this request fragment. | Validation output plus changed-file review for this unit. |
| U6 | "Once that is established, proceed to implementation." | Compaction planner must preserve this request fragment. | Validation output plus changed-file review for this unit. |
...
## Entry State
- The file `.docs/todo/changelog/142a-warm-index-compaction-ops-hardening.md` exists and carries non-PLACEHOLDER evidence.
...
- Compaction planner is complete and the next unit can verify it from filesystem state plus archived evidence.
...
## Next todo
`/todo/pending/142c-warm-index-compaction-ops-hardening.md`
...
- [x] Move this file to `/todo/changelog/142b-warm-index-compaction-ops-hardening.md` verified.
