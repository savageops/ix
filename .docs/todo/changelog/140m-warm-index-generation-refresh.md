---
id: 140m-warm-index-generation-refresh
...
phase: m
status: done
patch_scope: "Document refresh_epoch versus compact_epoch semantics."
blast_radius: high
...
evidence: "C:\\Users\\Savage\\.local\\zig\\zig-x86_64-windows-0.16.0\\zig.exe build test --summary all -> exit 0; Build Summary: 3/3 steps succeeded; 124/124 tests passed. Changed files: README.md, .docs/research/2026-05-11-warm-layer-sidecar-architecture.md. Documented .ix/index/current.ixgen, refresh_epoch reader visibility, compact_epoch future maintenance semantics, and no-pretend adoption boundary."
conflict_surface: ""
invariants:
...
entry_state: "Dependency 140l-warm-index-generation-refresh is archived with non-PLACEHOLDER evidence before this unit starts."
...
dependencies: "140l-warm-index-generation-refresh"
next_todo: /todo/pending/140n-warm-index-generation-refresh.md
...
## Execute Now
Docs update: Document refresh_epoch versus compact_epoch semantics.
...
## Entry State
- The file `.docs/todo/changelog/140l-warm-index-generation-refresh.md` exists and carries non-PLACEHOLDER evidence.
...
## Next todo
`/todo/pending/140n-warm-index-generation-refresh.md`
...
- [x] Move this file to `/todo/changelog/140m-warm-index-generation-refresh.md` verified.
