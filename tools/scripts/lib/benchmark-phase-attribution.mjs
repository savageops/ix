  ...
  const targetRounds = nextRepairTarget == null ? [] : roundsWithLeaks
    ...
    .map((round) => {
      ...
      return {
        ...
        candidateScanOpenPathMedianMs: optionalNumber(sourceRound.candidateScanOpenPathMedianMs),
        candidateScanOpenSyscallMedianMs: optionalNumber(sourceRound.candidateScanOpenSyscallMedianMs),
        ...
        candidateScanOpenSyscallMsPerFileMedian: optionalNumber(sourceRound.candidateScanOpenSyscallMsPerFileMedian),
