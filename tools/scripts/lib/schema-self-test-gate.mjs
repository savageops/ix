...
export function runSchemaSelfTest({
  ...
  const required = [
    ...
    "ripgrep_12_sample: paired previous-build evidence must run predecessor before current in the first pair",
    ...
    "older_snapshot_ladder: runnable round must run predecessor before current in the first pair: old",
